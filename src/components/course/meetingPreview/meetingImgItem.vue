<template>
    <div class='am-u-sm-12 am-u-md-6 am-u-lg-4' style='float:left;'>
        <div class='tpl-table-images-content'>
            ...
            <div class='tpl-i-title' style='height:20px;'><span class='content-hide tpl-1-font'>会议:{{data.taskName}}</span></div>
        ...
        <portal-meeting-detail ref="meetingDetail" ></portal-meeting-detail>
    </div>
</template>
<script>
    ...
    export default {
        ...
        components: {
            'portal-meeting-detail':MeetingDetail
        },
        props: ['data'],
        beforeMount(){
            let params={};
        ...
        methods: {
            ...
            detail(taskId,courseId){
                this.$refs.meetingDetail.show=true;
                this.$refs.meetingDetail.form={
                    taskId:taskId,
                    courseId:courseId
                };
            },
