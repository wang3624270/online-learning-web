<template>
    <div class='am-u-sm-12 am-u-md-6 am-u-lg-4' style='float:left;'>
        <div class='tpl-table-images-content'>
            ...
            <div class='tpl-i-title' style='height:20px;'><span class='content-hide tpl-1-font'>在线课程:{{data.taskName}}</span></div>
            ...
            <div class='tpl-table-images-content-block'>
                ...
                <div class='tpl-i-more content-hide'  style='height:72px;'>
                    <ul>
                        <span class='am-text-success tpl-1-font'>课程教师: {{data.teachGroup}}</span><br>
        ...
        <portal-course-detail ref="courseDetail" ></portal-course-detail>
    </div>
</template>
<script>
    ...
    export default {
        ...
        components: {
            'portal-course-detail':CourseDetail
        },
        props: ['data'],
        beforeMount(){
            let params={};
        ...
        methods: {
            ...
            detail(taskId,courseId){
                this.$refs.courseDetail.show=true;
                this.$refs.courseDetail.form={
                    taskId:taskId,
                    courseId:courseId
                };
            },
