    ...
    <div>
        <el-dialog :title="title" :visible.sync="show" width="800px" v-loading="loading" :close-on-click-modal="false">
            <el-form :inline="true" :model="form" ref="form" class="demo-form-inline" label-width="100px">
                <el-form-item label="课程实践名称" prop="name">
                    <el-input v-model="form.activityName" class="width-unified"  placeholder="请输入课程作业名称"></el-input>
                </el-form-item>
                ...
                <el-form-item label="实践地点" prop="place">
                    <el-input v-model="form.place" placeholder="请输入实践地点" style="width: 500px"></el-input>
                </el-form-item>
                <el-form-item label="实践目标" prop="content">
...
<script>
    ...
    export default {
        ...
        watch: {
            show(val) {
                if(val==true){
                    if(this.form.activityId==null || this.form.homeworkId==''){
                        this.resetForm('form');
                    }
                }
            }
