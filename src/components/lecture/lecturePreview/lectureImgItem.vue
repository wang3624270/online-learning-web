<template>
    <div class='am-u-sm-12 am-u-md-6 am-u-lg-4' style='float:left;'>
        <div class='tpl-table-images-content'>
            <div class='tpl-table-images-content-i-time'>讲座时间:<br>{{data.startTimeStr}} - {{data.endTimeStr}}</div>
            ...
            <div class='tpl-table-images-content-block'>
                ...
                <div class='tpl-i-more'>
                    <ul>
                        <span class='am-text-success tpl-1-font'>主讲:{{data.speaker}}</span><br>
                        <span class='am-text-warning'>报名起止时间:{{data.registStart}} - {{data.registEnd}}</span><br>
                        <span class='font-green tpl-1-font'>讲座地点:{{data.place}}</span>
                    </ul>
                </div>
