        ...
        <el-container>
            <el-header height="auto">
                <el-form :inline="true" :model="form" class="demo-form-inline" size="middle">
                    <el-form-item label="课程研讨主题">
                        <el-input v-model="form.theme" placeholder="请输入课程研讨主题"></el-input>
                    </el-form-item>
                    <el-form-item>
...
<script>
    ...
    import DiscussImgItem from './discussImgItem.vue';
    ...
    export default {
        ...
        components:{
            "portal-lecture-item":DiscussImgItem
        },
        methods:{
            search(){
                this.loading=true;
                let params=this.form;
                params.lectureType='2';
